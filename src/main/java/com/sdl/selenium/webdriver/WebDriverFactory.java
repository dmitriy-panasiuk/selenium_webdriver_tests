package com.sdl.selenium.webdriver;
...
import com.sdl.selenium.util.Browser;
import com.sdl.selenium.webdriver.AuthenticatedHtmlUnitDriver;
	...
	public static WebDriver getInstance(String gridHubUrl, Browser browser,
		...
		if (CHROME.equals(browserName)) {
			...
			if (username != null && password != null) {
                ...
                ffProfile.setPreference("network.automatic-ntlm-auth.trusted-uris", "strts01.ams.dev");
